...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Merelcoin Core merelcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  merelcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded merelcoin transaction") + "\n" +
              "  merelcoin-tx [options] -create [commands]   " + _("Create hex-encoded merelcoin transaction") + "\n" +
              "\n";
